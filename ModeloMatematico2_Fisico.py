...
def ModeloMatematico(C, N, A, K, Q, d_i, SOH, Bmax, Bmin, Error, FleetSize, e_FIXO_ij, e_ij, rotainicial = {}, S=[]):
    ...
    m.setObjective(
        gp.quicksum(x_ijk[i,j,k] * e_FIXO_ij[i, j] + e_ij[i,j] * f_ijk[i, j, k] for i,j in A for k in K),
